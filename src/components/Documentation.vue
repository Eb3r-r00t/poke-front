	...
	<div class="grid">
		<div class="col-12">
			<div class="card docs">
				...
				<h4>Dependencies</h4>
				<p>
					Babylon has no direct dependency other than PrimeVue. More information about dependencies is available at
...
"npm run test:unit": Runs the tests.
				...
				<p>Babylon consists of 2 main parts; the application layout and the resources. <i>App.vue</i> inside src
					...
					whereas required resources such as SASS structure for the layout are placed inside the <b>src/assets/</b>
					folder.</p>
	...
	return {
		menu : [
			...
			},
			{
				...
				<p>
					To setup Babylon in an existing project, follow the steps
					below;
				</p>
...
import './App.scss'; 	                            //your styles and overrides
				...
				<p>Babylon provides 17 PrimeVue themes out of the box, setup of a theme simple including the css of
					theme to your page that is located inside public/sass/theme folder
					such as <b>theme/theme-blue.css</b>.</p>
...
sass --update public/theme:public/theme
				...
				<p>Babylon offers 17 layout themes out of the box, setup of a layout theme simple including the css of
					theme to your page that is located inside public/layout/css folder such as
					<b>layout/css/layout-blue.css</b>.</p>
				...
				<ul>
					...
					<li>Define the variables listed below and import the <i>../../../src/assets/sass/layout/_layout.scss</i> file.</li>
					<li>Build the scss to generate css</li>
					<li>Include the theme file to your application.</li>
				</ul>
...
:root {
    ...
    --surface-hover: #e9ecef;
			...
			<ul>
				...
				<li>Slim: <b>layout-wrapper layout-slim</b></li>
